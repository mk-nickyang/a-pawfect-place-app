...
const SHOPIFY_STOREFRONT_API_URL = `https://${SHOP.slug}.myshopify.com/api/2024-01/graphql.json`;
const SHOPIFY_CUSTOMER_ACCOUNT_API_URL = `https://shopify.com/${SHOP.id}/account/customer/api/2023-10/graphql`;
