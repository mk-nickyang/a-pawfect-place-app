...
export const ShippingPolicy = () => {
  return (
    <ArticleScreenContainer>
      <Text variant="body1">
        Free shipping on orders over $50. Please do take into consideration that
        any discount applied to your order at checkout will affect your basket
        total. For orders less than $50, delivery will cost $10.
      </Text>
      ...
      <Text variant="body1">
        All the products will be shipped via Australia Post. You will receive an
        email with the tracking number and details as soon as your order is
        dispatched.
      </Text>
      ...
      <Text variant="body1">
        ...
        <Link
          type="browser"
          text="https://auspost.com.au/parcels-mail/calculate-postage-delivery-times/"
        />
        .
      </Text>
      ...
      <Text variant="body1" pb="m">
        ...
        shipping fees. If another shipping is requested, the shipping costs are
      ...
      <Text variant="body1">
        ...
        Japan, Macao SAR, Malaysia, Philippines, Singapore, South Korea, Taiwan,
        Thailand, Vietnam
      </Text>
      ...
      <Text variant="body1">
        ...
        Iceland, Ireland, Italy, Malta, Monaco, Montenegro, Netherlands, Norway,
